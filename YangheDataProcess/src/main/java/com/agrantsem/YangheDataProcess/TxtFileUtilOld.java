...
public class TxtFileUtilOld {
    ...
    public static int processShowCmFile(String readfilePath, String writePath) {
        ...
        try {
            ...
            while ((lineTxt = bufferedReader.readLine()) != null) {
                ...
                if (dataSplit.length < 4 || dataSplit[0] == null
                ...
                if (!last.startsWith(dataSplit[0])) {
                    ...
                    while (count < ((bushuCount % 4) + 2) && cutCount > 0 && last.length() > 0) {
     ...
     * @return
     */
    public static boolean processTTFile(String readfilePath, String writePath, HashSet<String> yangheSet, String magicPathName, String BFDVrdPathName) {
        ...
        try {
            ...
            while ((lineTxt = bufferedReader.readLine()) != null) {
                ...
                String[] dataSplit = lineTxt.split("\t", -1);
                if (dataSplit.length < 16 || dataSplit[0] == null
                        || dataSplit[0].length() == 0 || dataSplit[1] == null || dataSplit[1].length() == 1) {
                    continue;
                }
                ...
                //        String[] vrdList = dataSplit[16].split(",");
                //        for (String vrd : vrdList) {
                //            if(vrd!=null&&vrd.trim().length()>0){
                //                if(vrdSet.contains(vrd.trim())){
                //                    continue;
                //                }
                //                vrdSet.add(vrd.trim());
                //                if (bfdVrdMap.containsKey(vrd.trim())) {
                //                    String yhid = bfdVrdMap.get(vrd.trim()).trim();
                //                    if (yhid.length() > 0&&!yhid.equals(dataSplit[0].trim())) {
                //                        flag = 1;
                //                        writeTT.write(yhid + '\t' + dataSplit[1] + '\t'
                //                                + dataSplit[2] + '\t' + dataSplit[3] + '\t' + sex + '\t' + age + '\t' + setToString(diSet) + '\t' + dataSplit[6] + '\t' + dataSplit[7] + '\t' + dataSplit[8] + '\t' + dataSplit[9] + '\t' + dataSplit[10] + '\t' + dataSplit[11] + '\t' + dataSplit[12] + '\t' + dataSplit[14] + '\t' + dataSplit[15] + '\t' + dataSplit[16] + '\t' + flag + '\n');
                //                        break;
                //                    }
                //                }
                //            }
                ...
                //}
                writeTT.write(dataSplit[0] + '\t' + dataSplit[1] + '\t'
                        + dataSplit[2] + '\t' + dataSplit[3] + '\t' + sex + '\t' + age + '\t' + setToString(diSet) + '\t' + dataSplit[6] + '\t' + dataSplit[7] + '\t' + dataSplit[8] + '\t' + dataSplit[9] + '\t' + dataSplit[10] + '\t' + dataSplit[11] + '\t' + dataSplit[12] + '\t' + dataSplit[14] + '\t' + dataSplit[15] + '\t' + dataSplit[16] + '\t' + ua + '\n');
                //以前没有加工，这次加工了要保存
    ...
    public static void main(String[] args) {
        //processCutShow("C:/Users/think/Desktop/yanghe/last/ang-yanghe-show-20170219");
        //String mp="C:/Users/think/Downloads/magic.txt";//C:/Users/think/Desktop/yangheApp/magic.txt";
        //String mp = "C:\\Users\\think\\Desktop\\yangheApp\\magic.txt";
        //HashSet<String> yangheset = TxtFileUtil.getYangheSetFromFile(mp);
        //String path = "C:\\Users\\think\\Desktop\\YHData\\6.12\\tt-20170612";
        //String pathret = "C:\\Users\\think\\Desktop\\YHData\\6.12\\ang-tt-20170612";
